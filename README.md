...
Gosto de transformar ideias em sistemas executáveis, priorizando arquitetura clara, integração entre serviços, persistência de dados, APIs e documentação. Também utilizo IA como ferramenta de desenvolvimento e produtividade, buscando entender e conseguir explicar as decisões técnicas por trás de cada projeto.

Atualmente, venho aprofundando conhecimentos em **Python, Java, C, bancos de dados, redes, APIs, automações e arquitetura de software**.
...
- Orquestração de agentes e ferramentas de IA
- Testes, Git e documentação técnica
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:jggv2005@gmail.com)

---

> Este portfólio acompanha minha evolução como estudante e desenvolvedor. Os projetos são atualizados conforme novas versões, decisões arquiteturais e funcionalidades são implementadas.
